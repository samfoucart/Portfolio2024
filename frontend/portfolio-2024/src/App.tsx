    ...
    <>
      <div className="h-dvh flex flex-col">
            ...
            <div className="flex flex-row flex-wrap justify-center gap-x-8">
              <div className="flex flex-col flex-grow flex-shrink-0 basis-1/3">
                ...
                <p className="text-xl leading-8 text-left">
                  This is my text. I am explainining something longer here. On
                  Friday, I went to Steak and Shake with Claire, and it reminded
                  me of one of the first dates we wend on. In the February, when
                  we first started dating, I wasn't able to go to the homecoming
                  dance because I was too old. Instead, I went to see Wyclef
                  Jean with the Columbus Symphony Orchestra with my mom at the
                  Ohio Theater. On the way back, I wanted to get Steak and Shake
                  since she had mentioned it, and they were all inside, and I
                  joined them.
                </p>
              </div>
        ...
        <div className="bg-cyan-200 border-b-4 border-black">
          <div className="py-6 px-28 mx-auto w-6xl my-0"></div>
        </div>
        <div className="bg-pink-400 flex flex-col flex-grow items-center">
          <div className="p-28 w-6xl my-0">
            ...
            <p className="text-justify">
              This is my text. I am explainining something longer here. On
              Friday, I went to Steak and Shake with Claire, and it reminded me
              of one of the first dates we wend on. In the February, when we
              first started dating, I wasn't able to go to the homecoming dance
              because I was too old. Instead, I went to see Wyclef Jean with the
              Columbus Symphony Orchestra with my mom at the Ohio Theater. On
              the way back, I wanted to get Steak and Shake since she had
              mentioned it, and they were all inside, and I joined them.
            </p>
          </div>
        </div>
      </div>
